  ...
  <div class="relative inline-block text-left">
    <div id="wishlistButton">
      <button
        ...
        class="inline-flex items-center justify-center w-full py-2 text-sm font-medium hover:opacity-1/2 text-black hover:text-gray-900"
      ...
      <div class="py-1">
        ...
        <div>
          <nuxt-link to="/wishlist">
            <button v-if="items.length" class="text-ui-dark py-2 text-sm w-full border px-3 py-1.5 rounded hover:text-black hover:bg-gray-100">
              View Wish List
            </button>
          </nuxt-link>
        </div>
