      ...
      <div class="flex flex-col lg:flex-row">
        <div class="lg:w-3/5 lg:pr-14">
          <div class="flex">
            ...
            <div class="h-auto w-full flex-1 flex flex-col rounded-lg overflow-hidden shadow-2xl drop-shadow-2xl ">
        ...
        <div class="mt-8 lg:mt-0 lg:w-2/5 lg:max-w-xl">
          ...
          <div class="inline-flex mt-12">
            <button class="btn-ui !px-18 !py-5 !rounded-4xl !shadow-lg !bg-pink-900 !text-lg !mr-5" @click="addItem({variant_id, quantity})">
              ADD TO BAG
            </button>
            <quantity-selector
              :quantity="quantity"
          ...
          <div class="mt-12 mr-12">
            <hr class="border border-t-black">
            <div class="py-6">
              <h3 class="-my-3 flow-root">
                <button
                  class="p-3 rounded-xl w-full flex items-center justify-between text-sm text-gray-400 hover:text-gray-500"
                  type="button"
                >
                  <span class="text-lg text-gray-900 font-bold">Details</span>
              ...
              <div class="pt-6">
                <div class="space-y-4 text-black text-md font-semibold">
